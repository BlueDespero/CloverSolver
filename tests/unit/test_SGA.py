...
from genetic.plugin_algorithms.crossover import single_point_crossover, double_point_crossover, \
    exchange_two_boxes_crossover, \
...
from genetic.plugin_algorithms.mutation import reverse_bit_mutation, shuffle_row_mutation, shuffle_column_mutation, \
    shuffle_box_mutation
